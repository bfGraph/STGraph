...
from seastar.dataset.BoorahBase import BoorahBase
import torch
...
def main(args):
    ...
    # eng_covid = WikiMaths(verbose=True, for_seastar=True)
    eng_covid = BoorahBase(args.dataset ,verbose=True, for_seastar=True)
    ...
    edge_weight = to_default_device(torch.FloatTensor(edge_weight_list))
