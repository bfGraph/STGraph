...
def main(args):
    ...
    print("Num Nodes: ", dataloader.gdata["num_nodes"])
    print("Num Edges: ", dataloader.gdata["num_edges"])
    print("Num Timestamps: ", dataloader.gdata["total_timestamps"])
    ...
    try:
        for epoch in range(args.num_epochs):
            ...
            for index in range(num_iter):
                ...
                hidden_state = None
                y_hat = torch.randn(
                    (dataloader.gdata["num_nodes"], args.feat_size),
